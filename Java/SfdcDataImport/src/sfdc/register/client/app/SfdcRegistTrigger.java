 ...
 *
 */
public class SfdcRegistTrigger extends BaseTrigger {
	/** ログ部品 */
	private static Logger logger = Logger.getLogger(SfdcRegistTrigger.class);
    /**
	 * コンストラクタ
	 * @param ifid IFID
	...
	public static void main(String[] args) {
		...
		if (checkParam(args)) {
			...
			if (config.validate()) {
				...
				ICmdService service = new SfdcRegistService();
